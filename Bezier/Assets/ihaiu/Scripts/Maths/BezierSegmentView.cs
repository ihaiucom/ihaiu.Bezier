...
{
    [System.Serializable]
    public class BezierSegmentView : MonoBehaviour {
        ...
        [SerializeField]
        public BezierSegment    path            = new BezierSegment(Vector3.zero, new Vector3(2, 0, 2), new Vector3(-2, 0, 4), new Vector3(0, 0, 6));
